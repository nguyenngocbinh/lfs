...
clear
set more off
global data "E:\Google Drive\Data\Ldvl\"
global temp "F:\dropbox\temp\ldvl"

use "$data\lfs_2016_q1.dta", clear
	gen ky_3t =1
	gen w_p_q = cal_weigh 
tempfile file_q1
save `file_q1', replace

use "$data\lfs_2016_q2.dta", clear
	gen ky_3t =2
	gen w_p_q = cal_weigh_final
tempfile file_q2
save `file_q2', replace

use "$data\lfs_2016_q3.dta", clear
	gen ky_3t =3
	gen w_p_q = cal_weigh
...
recode train 1/8= 8 if c12 ==8 | c12 ==9 
...
#delimit cr
*/
do "F:\Dropbox\dofile\ldvl\support_ldvl2016.do"
...
save "$temp\ldvl_2016_q1-4.dta", replace
