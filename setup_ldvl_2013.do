...
gen hdkt = 1 if c16 ==1 | c17 ==1 | c18 ==1 | c21 ==1
recode hdkt (.=2) if c65 ==1 & c68 ==1 
gen temp = c67
recode temp 4/9 = 999
recode hdkt (.=2) if c68 ==1 & temp ==999 
...
do "E:\Dropbox\dofile\ldvl\support_ldvl2013.do"

gen hoatdong = labour_force
recode hoatdong .=2 if c72 == 1 
recode hoatdong .=3 if c72 >1 & c72 <=5
#delimit;
...
do "E:\Dropbox\dofile\ldvl\informal_2013.do"
...
time_tn prev_indus1  prev_nganh_N_C_D  prev_employment_status  prev_economic_sector prev_occup1 hinhthuctimviec lydokolv hoatdong tyle_ngheo bhxh ///
 bhyt hdld migration migration_reasons reg_migration  informal prod_uni
...
gen weight =  w_p_13
order `namelist' age weight tinh unemployment_rate under_emp_rate wage income weekhour lfp_rate extra_hours
compress
...
save "$temp\ldvl_2013.dta", replace
